    ...
    if not sheets_filtered.empty and ga4_df is not None and not ga4_df.empty:
        ...
        with tab_crecimiento:
            ...
            with col1:
                comparison_type = st.selectbox(
                    ...
                    key="comparison_type_redac_sancor"
                )
            ...
            if comparison_type == "custom":
                ...
                with col1:
                    current_start = st.date_input(
                        "Inicio actual:",
                        value=datetime.now() - timedelta(days=7),
                        key="growth_current_start_redac_sancor"
                    )
                with col2:
                    current_end = st.date_input(
                        "Fin actual:",
                        value=datetime.now(),
                        key="growth_current_end_redac_sancor"
                    )
                ...
                with col3:
                    previous_start = st.date_input(
                        ...
                        key="growth_previous_start_redac_sancor"
                    )
                with col4:
                    previous_end = st.date_input(
                        "Fin comparación:",
                        value=datetime.now() - timedelta(days=8),
                        key="growth_previous_end_redac_sancor"
                    )
            ...
            if historical_df is not None and not historical_df.empty:
                ...
                if 'autor' in historical_df.columns and historical_df['autor'].notna().any():
                    ...
                    selected_author = st.selectbox(
                        "Seleccionar autor:",
                        available_authors,
                        key="selected_author_historical_sancor"
                    )
        ...
        with tab7:
            ...
            period_filter = st.selectbox(
                ...
                key="period_filter_metrics_sancor"
            )
            ...
            if period_filter == "custom":
                ...
                with col1:
                    custom_start_date = st.date_input(
                        ...
                        key="custom_start_metrics_sancor"
                    )
                with col2:
                    custom_end_date = st.date_input(
                        "Fecha fin:",
                        value=datetime.now(),
                        key="custom_end_metrics_sancor"  
                    )
