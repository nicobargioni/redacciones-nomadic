...
country_filter = st.sidebar.selectbox(
    ...
    key="country_filter_mundodeportivo",
    ...
    **Posibles causas:**
    ...
    if not sheets_filtered.empty and ga4_df is not None and not ga4_df.empty:
        ...
        with tab1:
            ...
            st.markdown(f"""
            ### 🎯 Objetivo del Mes
            **Meta:** 2,500,000 de Page Views{' desde ' + country_filter if country_filter != "Todos los países" else ''}
            ...
            monthly_goal = 2500000  # 2.5 millones de Page Views
        ...
        with tab2:
            ...
            st.download_button(
                ...
                data=csv,
                file_name=f"mundodeportivo_data_{datetime.now().strftime('%Y%m%d_%H%M%S')}.csv",
                mime="text/csv"
            )
        ...
        with tab_historico:
            ...
            with col1:
                ...
                historical_period = st.selectbox(
                    ...
                    key="historical_period_mundodeportivo"
                )
            ...
            with col2:
                ...
                time_granularity = st.selectbox(
                    ...
                    key="time_granularity_mundodeportivo"
                )
            ...
            if historical_period == "custom":
                ...
                with col3:
                    hist_start_date = st.date_input(
                        ...
                        key="hist_start_mundodeportivo"
                    )
                with col4:
                    hist_end_date = st.date_input(
                        "Fecha fin:",
                        value=datetime.now(),
                        key="hist_end_mundodeportivo"
                    )
            else:
            ...
            if historical_df is not None and not historical_df.empty:
                ...
                if 'autor' in historical_df.columns and historical_df['autor'].notna().any():
                    ...
                    selected_author = st.selectbox(
                        "Seleccionar autor:",
                        available_authors,
                        key="selected_author_historical_mundodeportivo"
                    )
        ...
        with tab7:
            ...
            period_filter = st.selectbox(
                ...
                key="period_filter_metrics_mundodeportivo"
            )
            ...
            if period_filter == "custom":
                ...
                with col1:
                    custom_start_date = st.date_input(
                        ...
                        key="custom_start_metrics_mundodeportivo"
                    )
                with col2:
                    custom_end_date = st.date_input(
                        "Fecha fin:",
                        value=datetime.now(),
                        key="custom_end_metrics_mundodeportivo"  
                    )
